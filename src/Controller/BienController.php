...
class BienController extends AbstractController
{
     ...
     * @return Response
     */
    public function show(Bien $bien, BienRepository $bienRepository, string $slug, Request $request, ContactNotification $notification): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
		 $bien->setUser($user);
          ...
          $this->mailer->send($message);
            ...
            return $this->redirectToRoute('bien_edit', ['slug' => $bien->getSlug()]);
        }
    ...
    /**
     * @Route("/bien/{slug}/edit", name="bien_edit", methods="GET|POST")
     * @param Bien $bien
    ...
    /**
     * @Route("/bien/{slug}/delete", name="bien_delete", methods="GET|POST|DELETE")
     * @param Bien $bien
     * @return \Symfony\Component\HttpFoundation\RedirectResponse
     */
    public function delete(Bien $bien, Request $request, $slug): Response
	{
